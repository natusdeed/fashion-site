...
const FALLBACK_LIST: Product[] = [
  ...
  { id: 5, slug: "satin-maxi-dress", name: "Satin Maxi Dress", price: 479, category: "Dresses", imageUrl: "https://images.unsplash.com/photo-1594633312681-425c7b97ccd1?w=800&q=80", imageAlt: "Satin Maxi Dress - Lola Drip", description: "Flowing satin maxi dress.", sizes: ["XS", "S", "M", "L", "XL"], colors: [{ name: "Midnight Blue", value: "#1e293b" }, { name: "Sage", value: "#6b9080" }] },
  { id: 6, slug: "wool-tailored-pants", name: "Wool Tailored Pants", price: 349, category: "Bottoms", imageUrl: "https://images.unsplash.com/photo-1441986300917-64674bd600d8?w=800&q=80", imageAlt: "Wool Tailored Pants - Lola Drip", description: "Classic wool tailored pants.", sizes: ["XS", "S", "M", "L", "XL"], colors: [{ name: "Charcoal", value: "#374151" }, { name: "Navy", value: "#1e3a5f" }] },
  { id: 7, slug: "chiffon-blouse", name: "Chiffon Blouse", price: 299, category: "Tops", imageUrl: "https://images.unsplash.com/photo-1571945153237-4929e783af4a?w=800&q=80", imageAlt: "Chiffon Blouse - Lola Drip", description: "Elegant chiffon blouse.", sizes: ["XS", "S", "M", "L", "XL"], colors: [{ name: "Ivory", value: "#faf8f3" }, { name: "Blush", value: "#f4d5d5" }] },
  { id: 8, slug: "leather-midi-skirt", name: "Leather Midi Skirt", price: 429, category: "Bottoms", imageUrl: "https://images.unsplash.com/photo-1552902865-b72c031ac5ea?w=800&q=80", imageAlt: "Leather Midi Skirt - Lola Drip", description: "Stylish leather midi skirt.", sizes: ["XS", "S", "M", "L", "XL"], colors: [{ name: "Black", value: "#1a1a1a" }, { name: "Cognac", value: "#8b4513" }] },
  { id: 9, slug: "embroidered-jacket", name: "Embroidered Jacket", price: 579, category: "Outerwear", imageUrl: "https://images.unsplash.com/photo-1551488831-00ddcb6c6bd3?w=800&q=80", imageAlt: "Embroidered Jacket - Lola Drip", description: "Stunning embroidered jacket.", sizes: ["XS", "S", "M", "L", "XL"], colors: [{ name: "Ivory", value: "#faf8f3" }, { name: "Navy", value: "#1e3a5f" }] },
  { id: 10, slug: "silk-wrap-dress", name: "Silk Wrap Dress", price: 459, category: "Dresses", imageUrl: "https://images.unsplash.com/photo-1595777457583-95e059d581b8?w=800&q=80", imageAlt: "Silk Wrap Dress - Lola Drip", description: "Flattering silk wrap dress.", sizes: ["XS", "S", "M", "L", "XL"], colors: [{ name: "Floral", value: "#f4d5d5" }, { name: "Navy", value: "#1e3a5f" }] },
  { id: 11, slug: "tweed-blazer", name: "Tweed Blazer", price: 519, category: "Tops", imageUrl: "https://images.unsplash.com/photo-1591047139829-d91aecb6caea?w=800&q=80", imageAlt: "Tweed Blazer - Lola Drip", description: "Classic tweed blazer.", sizes: ["XS", "S", "M", "L", "XL"], colors: [{ name: "Herringbone Gray", value: "#6b7280" }, { name: "Camel", value: "#c19a6b" }] },
  { id: 12, slug: "organza-evening-gown", name: "Organza Evening Gown", price: 589, category: "Evening Wear", imageUrl: "https://images.unsplash.com/photo-1515886657613-9f3515b0c78f?w=800&q=80", imageAlt: "Organza Evening Gown - Lola Drip", description: "Breathtaking organza evening gown.", sizes: ["XS", "S", "M", "L", "XL"], colors: [{ name: "Ivory", value: "#faf8f3" }, { name: "Dusty Rose", value: "#c49a9a" }] },
];

export function getFallbackProducts(): Product[] {
  return FALLBACK_LIST.length > 0 ? FALLBACK_LIST : products.slice(0, 12);
}
