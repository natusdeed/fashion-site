  ...
  return (
    ...
    <div className="pt-40 pb-40 px-6 lg:px-8">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid lg:grid-cols-2 gap-24 lg:gap-32 mb-40">
              ...
              <div className="grid grid-cols-4 gap-4">
                {productImages.map((image: string, index: number) => (
                  <button
                    ...
                    className={`relative aspect-square bg-warm-100 overflow-hidden border-2 transition-all duration-300 rounded-sm ${
                      selectedImage === index
          ...
          <div className="flex flex-col">
              ...
              <div className="flex flex-wrap gap-4">
                {product.sizes?.map((size: string) => (
                  <button
                    ...
                    className={`px-6 py-3 border transition-all duration-300 text-xs uppercase tracking-[0.2em] font-light min-w-[60px] rounded-sm ${
                      selectedSize === size
            ...
            <div className="mb-12">
              <button
                ...
                className="w-full bg-warm-900 text-warm-50 px-10 py-6 hover:bg-warm-800 hover:text-gold-100 disabled:bg-warm-300 disabled:cursor-not-allowed transition-all duration-500 text-sm uppercase tracking-[0.3em] font-light group relative overflow-hidden hover:scale-[1.02] hover:shadow-xl disabled:hover:scale-100 disabled:hover:shadow-none rounded-sm border border-gold-500/20"
              >
                <span className="relative z-10 flex items-center justify-center">
                  Add to Bag
                  <svg
                    className="ml-3 w-5 h-5 transform group-hover:translate-x-1 transition-transform duration-500"
                    fill="none"
                    strokeLinecap="round"
                    strokeLinejoin="round"
                    strokeWidth="1.5"
